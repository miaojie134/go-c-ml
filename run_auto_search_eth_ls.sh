...
"$VENV_PY" auto_search_eth.py \
  ...
  --results-out ./models/eth_auto_search_ls_results.csv \
  --best-json-out ./models/eth_best_ls_config.json \
  --best-model-out ./models/eth_best_ls_model.txt \
  --best-equity-out ./models/eth_best_ls_equity.csv
